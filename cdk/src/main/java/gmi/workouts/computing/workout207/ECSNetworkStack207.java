...
public class ECSNetworkStack207 extends NestedStack {
    ...
    public ECSNetworkStack207(final Construct scope, final String id,
    ...
    private void createNetwork(VpcStack101 vpcStack101, BasicSubnetsStack102 basicSubnetsStack102) {
        ...
        CfnInternetGateway internetGateway = createAndAttachInternetGateway(this, vpcStack101.getVpc(), "cpu-207-igw");
        createAndAttachRouteTableToSubnets(this, "cpu-207-rt-1", vpcStack101.getVpc(), internetGateway, subnet1, subnet2);
        createAndAttachNatGateway(this, "cpu-207-nat", vpcStack101.getVpc(), subnet1, subnet3, subnet4);

        createSecurityGroup(vpcStack101);
    }

    private void createSecurityGroup(VpcStack101 vpcStack101) {
        albSecurityGroup = SecurityGroupHelper.createSecurityGroup(this, vpcStack101.getVpc(), "cpu-207-sg-1", HTTP);

        bastionSecurityGroup = SecurityGroupHelper.createSecurityGroup(this, vpcStack101.getVpc(), "cpu-207-sg-2");

        workerSecurityGroup = SecurityGroupHelper.createSecurityGroup(this, vpcStack101.getVpc(), "cpu-207-sg-3");
