...
public class EC2UserDataStack extends Stack {
    ...
    public EC2UserDataStack(final Construct scope, final String id, final StackProps props,
        ...
        CfnInternetGateway igw = createAndAttachInternetGateway(this, vpcStack.getVpc(), "cpu-202-igw");
        InternetGatewayHelper.createAndAttachRouteTableToSubnets(this, "cpu-202-rt-1", vpcStack.getVpc(), igw, subnet);
    ...
    private  CfnSecurityGroup createSecurityGroup(final CfnVPC vpc) {
        CfnSecurityGroup securityGroup = SecurityGroupHelper.createSecurityGroup(this, vpc, "cpu-202-sg", HTTP);
