...
public class ALBNetworkStack205 extends NestedStack {
    ...
    public ALBNetworkStack205(final Construct scope, final String id,
    ...
    private void createSecurityGroup(VpcStack101 vpcStack101) {
        albSecurityGroup = SecurityGroupHelper.createSecurityGroup(this, vpcStack101.getVpc(), "cpu-205-sg-1", HTTP);

        bastionSecurityGroup = SecurityGroupHelper.createSecurityGroup(this, vpcStack101.getVpc(), "cpu-205-sg-2");

        workerSecurityGroup = SecurityGroupHelper.createSecurityGroup(this, vpcStack101.getVpc(), "cpu-205-sg-3");
