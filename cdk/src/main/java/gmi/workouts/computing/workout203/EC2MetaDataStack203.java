...
public class EC2MetaDataStack203 extends Stack {
    ...
    public EC2MetaDataStack203(final Construct scope, final String id, final StackProps props,
    ...
    private  CfnSecurityGroup createSecurityGroup(VpcStack101 vpcStack101) {
        CfnSecurityGroup securityGroup = SecurityGroupHelper.createSecurityGroup(this, vpcStack101.getVpc(), "cpu-203-sg", HTTP);
