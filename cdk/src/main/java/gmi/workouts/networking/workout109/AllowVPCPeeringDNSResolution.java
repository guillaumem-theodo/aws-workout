...
public class AllowVPCPeeringDNSResolution extends Construct {
    public AllowVPCPeeringDNSResolution(@NotNull Construct scope, @NotNull String id, CfnVPCPeeringConnection peeringConnection) {
        super(scope, id);
