...
echo "✅ Trying to access S3 bucket from with EC2: $ec2_1_public_ip - should be OK"
ssh -i ./aws-workout-key-pair.pem -o ConnectTimeout=10 ec2-user@"$ec2_1_public_ip" aws s3 ls s3://unique-name-s3-bucket-1-203
