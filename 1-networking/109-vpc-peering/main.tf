...
resource "aws_subnet" "net-109-subnet-1" {
...
resource "aws_subnet" "net-109-subnet-2" {
...
resource "aws_subnet" "net-109-subnet-3" {
...
resource "aws_internet_gateway" "net-109-igw" {
  vpc_id = aws_vpc.net-109-vpc-3.id
  tags = {
    Purpose: var.dojo
    Name: "net-109-igw"
...
resource "aws_route" "net-109-rt-3-internet" {
  route_table_id = aws_vpc.net-109-vpc-3.default_route_table_id
  destination_cidr_block = "0.0.0.0/0"
  gateway_id = aws_internet_gateway.net-109-igw.id
}

resource "aws_security_group_rule" "net-109-sg-3-ssh" {
  from_port = 22
  protocol = "tcp"
...
resource "aws_instance" "net-109-ec2-1" {
  ami = data.aws_ami.amazon-linux.image_id
  instance_type = "t2.micro"
  associate_public_ip_address = true
  subnet_id = aws_subnet.net-109-subnet-1.id
...
resource "aws_instance" "net-109-ec2-2" {
  ami = data.aws_ami.amazon-linux.image_id
  instance_type = "t2.micro"
  associate_public_ip_address = true
  subnet_id = aws_subnet.net-109-subnet-2.id
  key_name = "aws-workout-key"
...
resource "aws_instance" "net-109-ec2-3" {
  ami = data.aws_ami.amazon-linux.image_id
  instance_type = "t2.micro"
  associate_public_ip_address = true
  subnet_id = aws_subnet.net-109-subnet-3.id
  key_name = "aws-workout-key"
...
resource "aws_route" "net-109-rt-3-2" {
  route_table_id = aws_vpc.net-109-vpc-3.default_route_table_id
...
resource "aws_security_group_rule" "net-109-sg-2-3" {
...
resource "aws_route" "net-109-route-2-1" {
  route_table_id = aws_vpc.net-109-vpc-2.default_route_table_id
...
resource "aws_route" "net-109-route-1-2" {
  route_table_id = aws_vpc.net-109-vpc-1.default_route_table_id
  destination_cidr_block = aws_vpc.net-109-vpc-2.cidr_block
  vpc_peering_connection_id = aws_vpc_peering_connection.net-109-peering-2-1.id
}

resource "aws_security_group_rule" "net-109-sg-1-2" {
...
output "net-109-ec2-1-public-ip" {
  value = aws_instance.net-109-ec2-1.public_ip
}

output "net-109-ec2-1-private-ip" {
  value = aws_instance.net-109-ec2-1.private_ip
}

output "net-109-ec2-1-public-dns" {
  value = aws_instance.net-109-ec2-1.public_dns
}

output "net-109-ec2-1-private-dns" {
  value = aws_instance.net-109-ec2-1.private_dns
}

output "net-109-ec2-2-public-ip" {
  value = aws_instance.net-109-ec2-2.public_ip
}

output "net-109-ec2-2-private-ip" {
  value = aws_instance.net-109-ec2-2.private_ip
}

output "net-109-ec2-2-public-dns" {
  value = aws_instance.net-109-ec2-2.public_dns
}

output "net-109-ec2-2-private-dns" {
  value = aws_instance.net-109-ec2-2.private_dns
}

output "net-109-ec2-3-public-ip" {
  value = aws_instance.net-109-ec2-3.public_ip
}

output "net-109-ec2-3-private-ip" {
  value = aws_instance.net-109-ec2-3.private_ip
}

output "net-109-ec2-3-public-dns" {
  value = aws_instance.net-109-ec2-3.public_dns
}

output "net-109-ec2-3-private-dns" {
  value = aws_instance.net-109-ec2-3.private_dns
}
