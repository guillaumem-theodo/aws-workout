...
ssh -i ./aws-workout-key-pair.pem -o ConnectTimeout=10 -J ec2-user@"$ec2_1_public_ip" ec2-user@"$ec2_2_private_ip" sudo traceroute -n -T -p 443 -m 6 "s3.us-east-1.amazonaws.com"
