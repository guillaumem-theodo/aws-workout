...
echo "✅ Trying to SSH into the private EC2 created in Tutorial 105 with private IP: $ec2_2_private_ip through bastion EC2: $ec2_1_public_ip"
ssh -i ./aws-workout-key-pair.pem -o ConnectTimeout=10 -o StrictHostKeyChecking=no -J ec2-user@"$ec2_1_public_ip" ec2-user@"$ec2_2_private_ip"
